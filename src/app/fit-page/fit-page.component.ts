...
export class FitPageComponent implements OnInit {
  jeanFitList: JeanFit[] = [
    ...
    new JeanFit("female", "MARILYN", "With a 27cm rise and tapered skinny leg, the Marilyn is our iconic super high-waisted skinny fit. Inspired by Marilyn Monroe.", "https://raw.githubusercontent.com/william-chu/epicodus-week8-9/master/src/assets/marilym_fit_women.jpg"),
    ...
    new JeanFit("male", "STUDIO", "A relaxed fit with cropped legs. If you’re looking for something else than skinny jeans we suggest that you’ll try this. It’s something else.", "https://raw.githubusercontent.com/william-chu/epicodus-week8-9/master/src/assets/lola_fit_women.jpg"),
  ];
  constructor() { }
